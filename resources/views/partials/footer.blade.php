            ...
            <div class="row">
                <div class="col-sm-8 col-md-4 footer__links-single">
                    ...
                    <ul class="footer__list">
                        <li><span class="footer--highlighted">Address:</span> <a href="#">Shyamoli,Rind Road,2/B/7</a></li>
                        <li><span class="footer--highlighted">Email:</span> <a
                                    href="mailto:RentalService@support.com">RentalService@support.com</a></li>
                        <li><span class="footer--highlighted">Phone:</span> <a href="tel:+8801743068092">(880)-1743068092</a>
                        </li>
                        <li><span class="footer--highlighted">Fax:</span> <a href="#">(880)-962126456</a></li>
                    </ul><!-- .footer__list -->
                </div><!-- .col -->
